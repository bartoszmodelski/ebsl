...
\todo{actually LIFO can be better for latency too! depends on hte shape of the tree}
\todo{LIFO is fair between subtrees while FIFO is fair between tasks. And we treat a task as a unit of work.}

Fairness is defined here alittle differently than e.g. fairness between long-lived processes.
...
\todo{show heuristics at 120 cores!}
\todo{show staged at 120 cores!}
