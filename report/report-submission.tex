...
\chapter{Design}
This chapter describes the design space of a scheduler. First,  \S\ref{section:objectives} states the desirable properties of scheduling policies and metrics to evaluate them. Afterwards, major approaches are described, and the remainder discusses other design choices.
