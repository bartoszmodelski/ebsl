...
While the infinite array is a powerful idea and some designs actually simulate that using a linked list of arrays (e.g. \cite{Sundell2011}), in practise use of circular buffer is far more common. Luckily, the design from \ref{section:mpmc_queue_on_inf} almost work on a circular array.
