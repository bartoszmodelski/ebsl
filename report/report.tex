...
\todo{Scheduling is a very literature-rich part of computer science. Summarising all the research up to date is far beyond the scope of this section. Therefore, I have selected two very modern and mature runtime schedulers, and analyzed them in depth. Go boasts to offer a very good concurrency support and its one of the main selling points. Rust is a high-perf language, it is a library scherules and non-preemptive! There is also Domainslib but its at a much earlier stage. It features a classic deque design. In the last section it is benchmarked against this project.}
...
\todo{there is the domainslib, although it does not seem to have been built with high core counts in mind}
...
The mixer benchmark represents a particularly complicated but real use case. It derives from architecture of a VoIP softswitch (\cite{Maruzzelli2017-ou}), which heavily relies on threading and linux scheduler. \todo{more details}
