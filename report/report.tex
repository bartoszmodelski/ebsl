...
Such a workload highlights the effects occuring when the cost of individual requests is multi-modal and expressed through varying size of task-tree. In the limit, if depth of some particular task-tree is infinite, the stuck task's latency also becomes infinite as they never get to execute.
