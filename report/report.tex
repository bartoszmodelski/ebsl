...
\begin{figure}
     \centering
     \includegraphics[width=0.80\textwidth]{eval/packet-basic-with-steal-counts2std.png}
     \caption{The performance achieved by packet processing benchmark with 50k tasks over varying number of cores. The panels show throughput, time, 3 latency percentiles and retries on insertion due to lack of space.}
...
\begin{figure} 
     ...
     \caption{The throughput achieved on packet processing benchmark with 50k tasks.}
